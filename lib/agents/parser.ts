...
export const PARSER_MODEL = "gpt-5-mini";

const PARSER_INSTRUCTIONS = `You extract discrete topics from an RFI (Request for Information) document supplied by the user.
...
export const PARSER_PROMPT_HASH = hashPrompt(PARSER_INSTRUCTIONS);
